...
def extract_financial_statements(pdf_file):
    ...
    From the above report, extract the key financial statements (if they exist): income statement, balance sheet, cash flow statement, 
    and shareholder returns. Return the output as multiple JSONs for each of the statements. Each JSON should contain the following fields:
    ...
    * Number reporting                   // Whether numbers are reported in thousands, millions, billions, etc. 
