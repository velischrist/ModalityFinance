                ...
                subMenu: [
                    {
                        ...
                        path: `${APP_PREFIX_PATH}/companies/dashboard`,
                        title: 'Dashboard',
                    ...
                    },
                    {
                        ...
                        title: 'Company List',
                        translateKey: 'nav.appsSales.companyList',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    },
                    {
                        ...
                        path: `${APP_PREFIX_PATH}/companies/company-edit/12`,
                        title: 'Company Edit',
                        translateKey: 'nav.appsSales.companyEdit',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    },
                    {
                        ...
                        path: `${APP_PREFIX_PATH}/documents/document-edit/ab`,
                        title: 'Document Edit',
                        translateKey: 'nav.appsSales.documentEdit',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    },
                    {
                        ...
                        title: 'New Company',
                        translateKey: 'nav.appsSales.companyNew',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
