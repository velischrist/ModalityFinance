...
const appsRoute: Routes = [
    ...
    // },
    {
        key: 'appsSales.companyList',
        path: `${APP_PREFIX_PATH}/companies/company-list`,
        component: lazy(() => import('@/views/companies/CompanyList')),
        authority: [ADMIN, USER],
    },
    {
        key: 'appsSales.companyEdit',
    ...
    },
    {
        ...
        path: `${APP_PREFIX_PATH}/documents/document-edit/:id`,
    ...
    //     component: lazy(() => import('@/views/virtualanalyst/HelpCenter')),
    //     authority: [ADMIN, USER],
    //     meta: {
    //         pageContainerType: 'gutterless',
    //     },
